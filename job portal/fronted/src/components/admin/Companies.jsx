      ...
      <div className="max-w-6xl mx-auto my-10 px-6">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-white/10 p-6 rounded-3xl shadow-[0_0_40px_rgba(56,189,248,0.1)] hover:shadow-sky-500/20 transition duration-300">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            />
            <Button onClick = {() => navigate("/admin/companies/create")} className="bg-gradient-to-r from-sky-600 to-indigo-600 text-white px-6 py-2 rounded-xl shadow-lg hover:from-sky-700 hover:to-indigo-700 transition-transform transform hover:scale-105 active:scale-95">
              New Company
            </Button>
          </div>
